...
BEGIN_MESSAGE_MAP(CMFCApplication5Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON0, &CMFCApplication5Dlg::OnBnClickedButton0)	
	ON_BN_CLICKED(IDC_INPUT_BUTTON, &CMFCApplication5Dlg::OnBnClickedInputButton)
...
void CMFCApplication5Dlg::OnBnClickedButton0()
{
...
void CMFCApplication5Dlg::OnBnClickedInputButton()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	if (m_password == "0427") {
		AfxMessageBox(_T("열림"));
