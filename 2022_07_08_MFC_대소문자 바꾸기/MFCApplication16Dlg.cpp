...
LRESULT CMFCApplication16Dlg::OnReceive(WPARAM length, LPARAM lpara)
{
	...
	if (led1 == '0')
	{
		m_edit_rcv_view_1.SetSel(0, -1, TRUE);
		m_edit_rcv_view_1.ReplaceSel(_T("OFF"));
	}
	else if (led1 == '1')
	{
		m_edit_rcv_view_1.SetSel(0, -1, TRUE);
		m_edit_rcv_view_1.ReplaceSel(_T("ON"));
	}

	if (led2 == '0')
	{
		m_edit_rcv_view_2.SetSel(0, -1, TRUE);
		m_edit_rcv_view_2.ReplaceSel(_T("OFF"));
	}
	else if (led2 == '1')
	{
		m_edit_rcv_view_2.SetSel(0, -1, TRUE);
		m_edit_rcv_view_2.ReplaceSel(_T("ON"));
	}

	if (led3 == '0')
	{
		m_edit_rcv_view_3.SetSel(0, -1, TRUE);
		m_edit_rcv_view_3.ReplaceSel(_T("OFF"));
	}
	else if (led3 == '1')
	{
		m_edit_rcv_view_3.SetSel(0, -1, TRUE);
		m_edit_rcv_view_3.ReplaceSel(_T("ON"));
	}
